...
const projects = [
  ...
  { id: 5, img: zone, name: 'A Business Recommender System Based on Zones and Commercial Data', info: 'Website allow the user to enter his capital and a spisific area and then the website will give him the suitable job for that area.', url: 'https://github.com/Salsabeel-Alzaqa/A-Business-Recommender-System', date: '10/2022 - 11/2022' },
];
const page = () => {
  return (
    <main>
